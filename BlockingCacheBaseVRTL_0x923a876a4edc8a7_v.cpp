//======================================================================
// VBlockingCacheBaseVRTL_0x923a876a4edc8a7_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_BlockingCacheBaseVRTL_0x923a876a4edc8a7/VBlockingCacheBaseVRTL_0x923a876a4edc8a7.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_BlockingCacheBaseVRTL_0x923a876a4edc8a7/VBlockingCacheBaseVRTL_0x923a876a4edc8a7__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t;

  // Exposed methods
  VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t * create_model( const char * );
  void destroy_model( VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t *);
  void eval( VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t * );

  #if VLINETRACE
  void trace( VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t *, char * );
  #endif
}
...
VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t * create_model( const char *vcd_filename ) {

  VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t * m;
  VBlockingCacheBaseVRTL_0x923a876a4edc8a7   * model;

  Verilated::randReset( 0 );

  m     = (VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t *) malloc( sizeof(VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t) );
  model = new VBlockingCacheBaseVRTL_0x923a876a4edc8a7();
...
void destroy_model( VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t * m ) {

  VBlockingCacheBaseVRTL_0x923a876a4edc8a7 * model = (VBlockingCacheBaseVRTL_0x923a876a4edc8a7 *) m->model;
...
void eval( VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t * m ) {
...
#if VLINETRACE
void trace( VBlockingCacheBaseVRTL_0x923a876a4edc8a7_t * m, char* str ) {
