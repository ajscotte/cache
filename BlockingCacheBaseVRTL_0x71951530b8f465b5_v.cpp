//======================================================================
// VBlockingCacheBaseVRTL_0x71951530b8f465b5_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_BlockingCacheBaseVRTL_0x71951530b8f465b5/VBlockingCacheBaseVRTL_0x71951530b8f465b5.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_BlockingCacheBaseVRTL_0x71951530b8f465b5/VBlockingCacheBaseVRTL_0x71951530b8f465b5__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VBlockingCacheBaseVRTL_0x71951530b8f465b5_t;

  // Exposed methods
  VBlockingCacheBaseVRTL_0x71951530b8f465b5_t * create_model( const char * );
  void destroy_model( VBlockingCacheBaseVRTL_0x71951530b8f465b5_t *);
  void eval( VBlockingCacheBaseVRTL_0x71951530b8f465b5_t * );

  #if VLINETRACE
  void trace( VBlockingCacheBaseVRTL_0x71951530b8f465b5_t *, char * );
  #endif
}
...
VBlockingCacheBaseVRTL_0x71951530b8f465b5_t * create_model( const char *vcd_filename ) {

  VBlockingCacheBaseVRTL_0x71951530b8f465b5_t * m;
  VBlockingCacheBaseVRTL_0x71951530b8f465b5   * model;

  Verilated::randReset( 0 );

  m     = (VBlockingCacheBaseVRTL_0x71951530b8f465b5_t *) malloc( sizeof(VBlockingCacheBaseVRTL_0x71951530b8f465b5_t) );
  model = new VBlockingCacheBaseVRTL_0x71951530b8f465b5();
...
void destroy_model( VBlockingCacheBaseVRTL_0x71951530b8f465b5_t * m ) {

  VBlockingCacheBaseVRTL_0x71951530b8f465b5 * model = (VBlockingCacheBaseVRTL_0x71951530b8f465b5 *) m->model;
...
void eval( VBlockingCacheBaseVRTL_0x71951530b8f465b5_t * m ) {
...
#if VLINETRACE
void trace( VBlockingCacheBaseVRTL_0x71951530b8f465b5_t * m, char* str ) {
