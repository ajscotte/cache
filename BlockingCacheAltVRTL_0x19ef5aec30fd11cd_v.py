#=======================================================================
# VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_v.py
#=======================================================================
...
#-----------------------------------------------------------------------
class BlockingCacheAltVRTL_0x19ef5aec30fd11cd( Model ):
  id_ = 0
  ...
  def __init__( s ):
    ...
    s._ffi = s.ffi.dlopen('./libBlockingCacheAltVRTL_0x19ef5aec30fd11cd_v.so')
    ...
    BlockingCacheAltVRTL_0x19ef5aec30fd11cd.id_ += 1
