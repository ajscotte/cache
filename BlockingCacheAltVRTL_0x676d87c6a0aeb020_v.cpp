//======================================================================
// VBlockingCacheAltVRTL_0x676d87c6a0aeb020_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_BlockingCacheAltVRTL_0x676d87c6a0aeb020/VBlockingCacheAltVRTL_0x676d87c6a0aeb020.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_BlockingCacheAltVRTL_0x676d87c6a0aeb020/VBlockingCacheAltVRTL_0x676d87c6a0aeb020__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t;

  // Exposed methods
  VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t * create_model( const char * );
  void destroy_model( VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t *);
  void eval( VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t * );

  #if VLINETRACE
  void trace( VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t *, char * );
  #endif
}
...
VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t * create_model( const char *vcd_filename ) {

  VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t * m;
  VBlockingCacheAltVRTL_0x676d87c6a0aeb020   * model;

  Verilated::randReset( 0 );

  m     = (VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t *) malloc( sizeof(VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t) );
  model = new VBlockingCacheAltVRTL_0x676d87c6a0aeb020();
...
void destroy_model( VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t * m ) {

  VBlockingCacheAltVRTL_0x676d87c6a0aeb020 * model = (VBlockingCacheAltVRTL_0x676d87c6a0aeb020 *) m->model;
...
void eval( VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t * m ) {
...
#if VLINETRACE
void trace( VBlockingCacheAltVRTL_0x676d87c6a0aeb020_t * m, char* str ) {
