//======================================================================
// VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_BlockingCacheAltVRTL_0x19ef5aec30fd11cd/VBlockingCacheAltVRTL_0x19ef5aec30fd11cd.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_BlockingCacheAltVRTL_0x19ef5aec30fd11cd/VBlockingCacheAltVRTL_0x19ef5aec30fd11cd__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t;

  // Exposed methods
  VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t * create_model( const char * );
  void destroy_model( VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t *);
  void eval( VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t * );

  #if VLINETRACE
  void trace( VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t *, char * );
  #endif
}
...
VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t * create_model( const char *vcd_filename ) {

  VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t * m;
  VBlockingCacheAltVRTL_0x19ef5aec30fd11cd   * model;

  Verilated::randReset( 0 );

  m     = (VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t *) malloc( sizeof(VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t) );
  model = new VBlockingCacheAltVRTL_0x19ef5aec30fd11cd();
...
void destroy_model( VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t * m ) {

  VBlockingCacheAltVRTL_0x19ef5aec30fd11cd * model = (VBlockingCacheAltVRTL_0x19ef5aec30fd11cd *) m->model;
...
void eval( VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t * m ) {
...
#if VLINETRACE
void trace( VBlockingCacheAltVRTL_0x19ef5aec30fd11cd_t * m, char* str ) {
