//======================================================================
// VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_BlockingCacheBaseVRTL_0x1a6e7cff4c59c28/VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_BlockingCacheBaseVRTL_0x1a6e7cff4c59c28/VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t;

  // Exposed methods
  VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t * create_model( const char * );
  void destroy_model( VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t *);
  void eval( VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t * );

  #if VLINETRACE
  void trace( VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t *, char * );
  #endif
}
...
VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t * create_model( const char *vcd_filename ) {

  VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t * m;
  VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28   * model;

  Verilated::randReset( 0 );

  m     = (VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t *) malloc( sizeof(VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t) );
  model = new VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28();
...
void destroy_model( VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t * m ) {

  VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28 * model = (VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28 *) m->model;
...
void eval( VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t * m ) {
...
#if VLINETRACE
void trace( VBlockingCacheBaseVRTL_0x1a6e7cff4c59c28_t * m, char* str ) {
