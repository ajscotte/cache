//======================================================================
// VBlockingCacheAltVRTL_0x7023474b19b819c4_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_BlockingCacheAltVRTL_0x7023474b19b819c4/VBlockingCacheAltVRTL_0x7023474b19b819c4.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_BlockingCacheAltVRTL_0x7023474b19b819c4/VBlockingCacheAltVRTL_0x7023474b19b819c4__Syms.h"
#include "svdpi.h"
#endif
...
VBlockingCacheAltVRTL_0x7023474b19b819c4_t * create_model( const char *vcd_filename ) {

  VBlockingCacheAltVRTL_0x7023474b19b819c4_t * m;
  VBlockingCacheAltVRTL_0x7023474b19b819c4   * model;

  Verilated::randReset( 0 );

  m     = (VBlockingCacheAltVRTL_0x7023474b19b819c4_t *) malloc( sizeof(VBlockingCacheAltVRTL_0x7023474b19b819c4_t) );
  model = new VBlockingCacheAltVRTL_0x7023474b19b819c4();
...
void destroy_model( VBlockingCacheAltVRTL_0x7023474b19b819c4_t * m ) {

  VBlockingCacheAltVRTL_0x7023474b19b819c4 * model = (VBlockingCacheAltVRTL_0x7023474b19b819c4 *) m->model;
...
void eval( VBlockingCacheAltVRTL_0x7023474b19b819c4_t * m ) {
...
#if VLINETRACE
void trace( VBlockingCacheAltVRTL_0x7023474b19b819c4_t * m, char* str ) {
