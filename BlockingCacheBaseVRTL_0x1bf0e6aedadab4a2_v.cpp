//======================================================================
// VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_BlockingCacheBaseVRTL_0x1bf0e6aedadab4a2/VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_BlockingCacheBaseVRTL_0x1bf0e6aedadab4a2/VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t;

  // Exposed methods
  VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t * create_model( const char * );
  void destroy_model( VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t *);
  void eval( VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t * );

  #if VLINETRACE
  void trace( VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t *, char * );
  #endif
}
...
VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t * create_model( const char *vcd_filename ) {

  VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t * m;
  VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2   * model;

  Verilated::randReset( 0 );

  m     = (VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t *) malloc( sizeof(VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t) );
  model = new VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2();
...
void destroy_model( VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t * m ) {

  VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2 * model = (VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2 *) m->model;
...
void eval( VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t * m ) {
...
#if VLINETRACE
void trace( VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_t * m, char* str ) {
