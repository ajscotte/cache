#=======================================================================
# VBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_v.py
#=======================================================================
...
#-----------------------------------------------------------------------
class BlockingCacheBaseVRTL_0x1bf0e6aedadab4a2( Model ):
  id_ = 0
  ...
  def __init__( s ):
    ...
    s._ffi = s.ffi.dlopen('./libBlockingCacheBaseVRTL_0x1bf0e6aedadab4a2_v.so')
    ...
    BlockingCacheBaseVRTL_0x1bf0e6aedadab4a2.id_ += 1
