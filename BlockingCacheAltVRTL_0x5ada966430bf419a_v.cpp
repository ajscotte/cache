//======================================================================
// VBlockingCacheAltVRTL_0x5ada966430bf419a_v.cpp
//======================================================================
// This wrapper exposes a C interface to CFFI so that a
// Verilator-generated C++ model can be driven from Python.
//

#include "obj_dir_BlockingCacheAltVRTL_0x5ada966430bf419a/VBlockingCacheAltVRTL_0x5ada966430bf419a.h"
#include "stdio.h"
#include "stdint.h"
#include "verilated.h"
...
#if VLINETRACE
#include "obj_dir_BlockingCacheAltVRTL_0x5ada966430bf419a/VBlockingCacheAltVRTL_0x5ada966430bf419a__Syms.h"
#include "svdpi.h"
#endif
...
extern "C" {
  ...
  } VBlockingCacheAltVRTL_0x5ada966430bf419a_t;

  // Exposed methods
  VBlockingCacheAltVRTL_0x5ada966430bf419a_t * create_model( const char * );
  void destroy_model( VBlockingCacheAltVRTL_0x5ada966430bf419a_t *);
  void eval( VBlockingCacheAltVRTL_0x5ada966430bf419a_t * );

  #if VLINETRACE
  void trace( VBlockingCacheAltVRTL_0x5ada966430bf419a_t *, char * );
  #endif
}
...
VBlockingCacheAltVRTL_0x5ada966430bf419a_t * create_model( const char *vcd_filename ) {

  VBlockingCacheAltVRTL_0x5ada966430bf419a_t * m;
  VBlockingCacheAltVRTL_0x5ada966430bf419a   * model;

  Verilated::randReset( 0 );

  m     = (VBlockingCacheAltVRTL_0x5ada966430bf419a_t *) malloc( sizeof(VBlockingCacheAltVRTL_0x5ada966430bf419a_t) );
  model = new VBlockingCacheAltVRTL_0x5ada966430bf419a();
...
void destroy_model( VBlockingCacheAltVRTL_0x5ada966430bf419a_t * m ) {

  VBlockingCacheAltVRTL_0x5ada966430bf419a * model = (VBlockingCacheAltVRTL_0x5ada966430bf419a *) m->model;
...
void eval( VBlockingCacheAltVRTL_0x5ada966430bf419a_t * m ) {
...
#if VLINETRACE
void trace( VBlockingCacheAltVRTL_0x5ada966430bf419a_t * m, char* str ) {
